...
/*   Updated: 2023/01/31 03:05:06 by aabda            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	ft_parse_args(t_global *g, const char **argv)
{
	...
	g->params.nbr_philo_must_eat = ft_atoi(argv[5]);
	return (g->err_check);
}
...
int	ft_init_struct(t_global *g, const char **argv)
{
	...
	ft_check_args(g);
	ft_print_lst(g);
	// printf("1 = %d\n2 = %d\n3 = %d\n4 = %d\n5 = %d\n", g->params.nbr_philo, g->params.time_to_die, g->params.time_to_eat, g->params.time_to_sleep, g->params.nbr_philo_must_eat);
}
